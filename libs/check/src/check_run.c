...
ALIGNED(32) static L4_Word_t stack[STACK_SIZE];
...
#define KTEST_SPACE     L4_SpaceId(*(OKL4_ENV_GET_MAIN_SPACEID("MAIN_SPACE_ID")))
  ...
  r = L4_ThreadControl(tid, KTEST_SPACE, KTEST_SERVER, KTEST_SERVER, KTEST_SERVER,
